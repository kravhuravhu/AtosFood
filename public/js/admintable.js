...
document.getElementById('adminForm').addEventListener('submit', function(event) {
    ...
    if (pass != passc) {
        ...
        fetch('../admin/admintable/add_staff.php',{
            method: 'POST',
            body: formData
        })
...
function fetchStaffData() {
    fetch('../admin/admintable/get_staff.php')
...
function addAdminToTable(userID, firstName, lastName, email, password, phone, activeSince) {
    ...
    passCell.classList.add('password');
...
function deleteAdmin(userID, row) {
    ...
    fetch('../admin/admintable/delete_staff.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.text())
...
function saveAdmin(row) {
    ...
    // fetch data to edit
    fetch('../admin/admintable/edit_staff.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.text())
