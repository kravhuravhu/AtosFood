              ...
              <div class="suite">
                <div class="image-stack">
                  ...
                  <div class="image-stack-item image-stack-item-bottom">
                    <div class="overlay"></div>
                    <img src="/images/right.png" alt="Image" class="img-fluid pic2">
                  </div>
                </div>
              </div> <!-- .suite -->
 
              <div class="suite-contents" data-jarallax-element="50">
                <h2 class="suite-title">Atos Food</h2>
                <div class="suite-excerpt">
                  <p> Atos Food is an innovative online meal ordering platform designed to streamline office lunchtime routines for office workers. It allows direct ordering from their offices, ensuring healthy, timely meals without waiting in line, enhancing the work environment dining experience.</p>
                </div>
              </div>
            </div>
</div>
            ...
            <div class="row custom-row-02192 align-items-stretch">
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  <div class="media-29191-icon">
                    <img src="../admin/dist/img/userIcon.png" alt="Image" class="img-fluid">
                  </div>
                  <h3>Londiwe Nkambule</h3>
              ...
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  ...
                  <h3>Tshepiso Motaung</h3>
                    Business Analyst / Front-End Developer.</p>
                    <div class="media-29190">
                        <span class="label">Social</span>
                        <ul class="icons-top icons-dark">
                            <li><a href="https://www.facebook.com/Atos/"><span class="icon-facebook"></span></a></li>
...
</html><?php /**PATH C:\xampp2\htdocs\Monday 29 July 2024\resources\views/about.blade.php ENDPATH**/ ?>